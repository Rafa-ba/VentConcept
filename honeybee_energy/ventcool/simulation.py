...
class VentilationSimulationControl(object):
    ...
    def to_idf(self):
        values = (self.vent_control_type, self.reference_temperature, self.reference_pressure,
                    self.reference_humidity_ratio, self.building_type, self.long_axis_angle,
                    self.aspect_ratio)
        comments = ('vent_control_type', 'reference_temperature', 'reference_pressure'
                    'reference_humidity_ratio', 'building_type', 'long_axis_angle',
                    'aspect_ratio')

        return generate_idf_string('VentilationSimulationControl', values, comments)
