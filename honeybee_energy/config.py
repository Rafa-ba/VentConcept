...
class Folders(object):
    ...
    def config_file(self, cfg):
        if cfg is None:
            cfg = os.path.join(get_packaged_files_path(), 'venv\\Lib\\site-packages\\honeybee_energy\\', 'config.json')
    ...
    def _find_honeybee_openstudio_gem_path(self):
        ...
        return os.path.join(get_packaged_files_path(), 'venv\\Lib\\site-packages\\honeybee_energy\\measures\\honeybee_openstudio_gem\\lib')
    ...
    def _find_standards_data_folder():
        ...
        print(os.path.join(os.path.dirname(honeybee_standards.__file__)), "BLUE BANANA")
        # return os.path.join(os.path.dirname(honeybee_standards.__file__))
        return os.path.join(get_packaged_files_path(), 'venv\\Lib\\site-packages\\honeybee_standards')
    ...
    def _find_standards_extension_folders():
        ...
        cwd = get_packaged_files_path()
        return ([os.path.join(cwd, 'venv\\Lib\\site-packages\\honeybee_standards')])
    @staticmethod
    def _check_standards_folder(path, check_defaults=False):
        ...
        _schedule_lib = os.path.join(cwd, 'venv\\Lib\\site-packages\\honeybee_standards\\schedules')
        _programtype_lib = os.path.join(cwd, 'venv\\Lib\\site-packages\\honeybee_standards\\programtypes')
        _energy_default = os.path.join(cwd, 'venv\\Lib\\site-packages\\honeybee_standards\\energy_default.json')
        ...
        print(_construction_lib, _constructionset_lib, _schedule_lib, \
            _programtype_lib, _energy_default, "maracuja")
