...
class Face3D(Base2DIn3D):
    ...
    def is_centered_adjacent(self, face, tolerance=0.02):
        ...
        if not self.center.is_equivalent(face.center, tolerance):  # center check
            print("fffffffffffffffffffffffffalse")
            return False
        # if self.min.x - face.min.x <= tolerance and self.min.y - face.min.y <= tolerance and self.min.z - face.min.z <= tolerance:

        #     return True
        # print(self.min.x - face.min.x, self.min.y - face.min.y, self.min.z - face.min.z)
