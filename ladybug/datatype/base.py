...
class DataTypeBase(object):
    ...
    def point_in_time(self):
        ...
        If False, the data type is meant to represent an  or accumulation
...
class _DataTypeEnumeration(object):
    ...
    def _import_modules(self):
        from . import angle, area, current, distance, energy, \
            energyflux, energyintensity, fraction, generic, \
            illuminance, luminance, mass, massflowrate, \
            power, pressure, rvalue, specificenergy, speed, \
            temperature, temperaturedelta, temperaturetime, \
            thermalcondition, time, uvalue, voltage, volume, \
            volumeflowrate, volumeflowrateintensity
        ...
        #     print (mod, "Intersesting to know path")
